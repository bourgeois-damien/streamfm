...
image = (
    ...
    # need real nvcc (pip wheel is ptxas-only)
    .run_commands(
    ...
    # exclude __pycache__: concurrent sweeps rewrite .pyc and Modal aborts the build
    .add_local_dir(
...
def _run_modal_benchmark(
    *,
    ...
    if quality:
        ...
        # INT8 quality runs: dump the TRT inspector next to the audio (proves what was quantized)
