...
def _add_common_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--task", default="se", help="se, stftpr, bwe, derev, lyra, melflow")
    parser.add_argument("--variant", default="baseline")
    parser.add_argument("--config-name", default="")
    parser.add_argument("--config-override", action="append", default=[], help="Hydra override (repeatable)")
    ...
    parser.add_argument(
        ...
        help="offline = enhance(); streaming = frame-causal",
    )
    parser.add_argument(
        "--execution",
        default="eager",
        help="eager | compiled | cuda_graph | tensorrt",
    )
    parser.add_argument("--trt-precision", default="fp16", choices=("fp32", "fp16", "int8"))
    parser.add_argument("--trt-calib-steps", type=int, default=96)
    parser.add_argument("--trt-tf32", default="auto", choices=("auto", "on", "off"))
    ...
    parser.add_argument("--solver", default="euler", help="e.g. euler or 5xeuler")
    parser.add_argument("--steps", type=int, default=5)
    parser.add_argument("--limit", type=int, default=0, help="0 = all after offset")
    parser.add_argument("--offset", type=int, default=0)
    parser.add_argument("--selection", default="random", choices=("first", "random"))
    ...
    parser.add_argument("--crop-mode", default="full", choices=("config", "full"))
    parser.add_argument(
        "--memory-format",
        default="contiguous",
    ...
    parser.add_argument("--score-after-run", action="store_true")
    parser.add_argument("--score-with-distillmos", action="store_true")
    parser.add_argument("--score-include-stats", action="store_true")
    parser.add_argument("--score-include-per-file", action="store_true")
