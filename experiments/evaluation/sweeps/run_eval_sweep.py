...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run an eval sweep (local or Modal).")
    parser.add_argument("--sweep-yaml", default="experiments/evaluation/sweeps/configs/sweep.yaml")
    parser.add_argument("--group", default="")
    parser.add_argument("--dry-run", action="store_true")
    parser.add_argument("--resume", action="store_true", help="Skip trials that already have metrics")
