...
def main() -> None:
    parser = argparse.ArgumentParser(description="Upload eval history JSON to W&B.")
    ...
    parser.add_argument("--wandb-group-prefix", default="")
    parser.add_argument("--limit-runs", type=int, default=0, help="0 = all")
    parser.add_argument("--no-include-scores", action="store_true")
